...
namespace Solvtio.Data.Implementations
{
    public class NomencladorReadOnlyRepository : INomencladorReadOnlyRepository
    {
        ...
        public async Task<List<Gnr_TipoEstadoMotivo>> GetTipoEstadoMotivoByTipoEstado(ExpedienteEstadoTipo estadoTipo)
        {
            var idTipoEstado = (int)estadoTipo;
            var query = _context.Gnr_TipoEstadoMotivoSet
                .AsNoTracking()
                .Where(x => x.IdTipoEstado == idTipoEstado);
