...
{
    [Table("ExpedienteEstadoBastanteoFinalizacion")]
    public class ExpedienteEstadoBastanteoFinalizacion
    {
        #region Constructors

        public ExpedienteEstadoBastanteoFinalizacion()
        {
        }
        public ExpedienteEstadoBastanteoFinalizacion(int idExpedienteEstado)
        {
