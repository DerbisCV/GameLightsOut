...
{
    [Table("ExpedienteEstadoCambiarioFinalizacion")]
    public class ExpedienteEstadoCambiarioFinalizacion
    {
        #region Constructors

        public ExpedienteEstadoCambiarioFinalizacion()
        {
        }
        public ExpedienteEstadoCambiarioFinalizacion(int idExpedienteEstado)
        {
        ...
        internal void Refresh(ExpedienteEstadoCambiarioFinalizacion model)
        {
