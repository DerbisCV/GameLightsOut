...
{
    [Table("ExpedienteEstadoContenciosoAdministrativoFinalizacion")]
    public class ExpedienteEstadoContenciosoAdministrativoFinalizacion
    {
        #region Constructors

        public ExpedienteEstadoContenciosoAdministrativoFinalizacion()
        {
        }
        public ExpedienteEstadoContenciosoAdministrativoFinalizacion(int idExpedienteEstado)
        {
        ...
        internal void Refresh(ExpedienteEstadoContenciosoAdministrativoFinalizacion model)
        {
