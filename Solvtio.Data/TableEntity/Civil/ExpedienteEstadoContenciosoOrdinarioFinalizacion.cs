...
{
    [Table("ExpedienteEstadoContenciosoOrdinarioFinalizacion")]
    public class ExpedienteEstadoContenciosoOrdinarioFinalizacion
    {
        #region Constructors

        public ExpedienteEstadoContenciosoOrdinarioFinalizacion()
        {
        }
        public ExpedienteEstadoContenciosoOrdinarioFinalizacion(int idExpedienteEstado)
        {
        ...
        internal void Refresh(ExpedienteEstadoContenciosoOrdinarioFinalizacion model)
        {
