...
{
    [Table("ExpedienteEstadoDdlFinalizacion")]
    public class ExpedienteEstadoDdlFinalizacion
    {
        #region Constructors

        public ExpedienteEstadoDdlFinalizacion()
        {
        }
        public ExpedienteEstadoDdlFinalizacion(int idExpedienteEstado)
        {
        ...
        internal void Refresh(ExpedienteEstadoDdlFinalizacion model)
        {
