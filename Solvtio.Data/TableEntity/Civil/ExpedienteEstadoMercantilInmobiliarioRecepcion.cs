...
{
    [Table("ExpedienteEstadoMercantilInmobiliarioRecepcion")]
    public class ExpedienteEstadoMercantilInmobiliarioRecepcion : EstadoRecepcionBase, IExpedienteEstadoChild
    {
        #region Constructors

        public ExpedienteEstadoMercantilInmobiliarioRecepcion()
        {
        }
        public ExpedienteEstadoMercantilInmobiliarioRecepcion(int idExpedienteEstado)
        {
        ...
        internal void Refresh(ExpedienteEstadoMercantilInmobiliarioRecepcion model)
        {
