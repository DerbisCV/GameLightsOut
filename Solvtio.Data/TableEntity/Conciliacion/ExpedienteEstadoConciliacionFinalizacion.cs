...
{
    [Table("ExpedienteEstadoConciliacionFinalizacion")]
    public class ExpedienteEstadoConciliacionFinalizacion
    {
        #region Constructors

        public ExpedienteEstadoConciliacionFinalizacion()
        {
        }
        public ExpedienteEstadoConciliacionFinalizacion(int idExpedienteEstado)
        {
