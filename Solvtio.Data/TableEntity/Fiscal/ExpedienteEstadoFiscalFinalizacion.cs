...
{
    [Table("ExpedienteEstadoFiscalFinalizacion")]
    public class ExpedienteEstadoFiscalFinalizacion
    {
        #region Constructors

        public ExpedienteEstadoFiscalFinalizacion()
        {
        }
        public ExpedienteEstadoFiscalFinalizacion(int idExpedienteEstado)
        {
