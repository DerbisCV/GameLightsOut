...
{
    [Table("ExpedienteEstadoJuraCuentaFinalizacion")]
    public class ExpedienteEstadoJuraCuentaFinalizacion
    {
        #region Constructors

        public ExpedienteEstadoJuraCuentaFinalizacion()
        {
        }
        public ExpedienteEstadoJuraCuentaFinalizacion(int idExpedienteEstado)
        {
