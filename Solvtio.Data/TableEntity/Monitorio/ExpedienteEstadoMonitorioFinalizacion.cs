...
{
    [Table("ExpedienteEstadoMonitorioFinalizacion")]
    public class ExpedienteEstadoMonitorioFinalizacion
    {
        #region Constructors

        public ExpedienteEstadoMonitorioFinalizacion()
        {
        }
        public ExpedienteEstadoMonitorioFinalizacion(int idExpedienteEstado)
        {
