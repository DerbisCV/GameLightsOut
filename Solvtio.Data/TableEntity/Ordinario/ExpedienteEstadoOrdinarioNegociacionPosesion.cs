...
{
    [Table("ExpedienteEstadoOrdinarioNegociacionPosesion")]
    public class ExpedienteEstadoOrdinarioNegociacionPosesion
    {
        #region Constructors

        public ExpedienteEstadoOrdinarioNegociacionPosesion()
        {
        }
        public ExpedienteEstadoOrdinarioNegociacionPosesion(int idExpedienteEstado)
        {
