...
{
    [Table("ExpedienteEstadoOrdinarioPresentacionDemanda")]
    public class ExpedienteEstadoOrdinarioPresentacionDemanda : EstadoPresentacionDemandaBase
    {
        #region Constructors

        public ExpedienteEstadoOrdinarioPresentacionDemanda()
        {
        }
        public ExpedienteEstadoOrdinarioPresentacionDemanda(int idExpedienteEstado)
        {
