...
{
    [Table("ExpedienteEstadoOrdinarioCsAdjudicacion")]
    public class ExpedienteEstadoOrdinarioCsAdjudicacion
    {
        #region Constructors

        public ExpedienteEstadoOrdinarioCsAdjudicacion()
        {
        }
        public ExpedienteEstadoOrdinarioCsAdjudicacion(int idExpedienteEstado)
        {
