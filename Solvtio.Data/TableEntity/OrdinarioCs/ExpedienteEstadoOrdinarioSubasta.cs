...
{
    [Table("ExpedienteEstadoOrdinarioCsSubasta")]
    public class ExpedienteEstadoOrdinarioCsSubasta
    {
		#region Constructors

		public ExpedienteEstadoOrdinarioCsSubasta()
		{
			TipoModeloSubastaId = 1;
			SubastaSuspension = Postores = Titulizado = AdjudicacionCliente = Oposicion = Consignar = IVA = false;
		}
        public ExpedienteEstadoOrdinarioCsSubasta(int idExpedienteEstado)
        {
