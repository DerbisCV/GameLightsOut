...
{
    [Table("ExpedienteEstadoPenalFinalizacion")]
    public class ExpedienteEstadoPenalFinalizacion
    {
        #region Constructors

        public ExpedienteEstadoPenalFinalizacion()
        {
        }
        public ExpedienteEstadoPenalFinalizacion(int idExpedienteEstado)
        {
