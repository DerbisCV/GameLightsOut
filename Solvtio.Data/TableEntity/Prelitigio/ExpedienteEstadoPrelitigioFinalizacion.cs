...
{
    [Table("ExpedienteEstadoPrelitigioFinalizacion")]
    public class ExpedienteEstadoPrelitigioFinalizacion
    {
        #region Constructors

        public ExpedienteEstadoPrelitigioFinalizacion()
        {
        }
        public ExpedienteEstadoPrelitigioFinalizacion(int idExpedienteEstado)
        {
