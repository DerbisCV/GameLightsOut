...
{
    [Table("ExpedienteEstadoSaneamientoFinalizacion")]
    public class ExpedienteEstadoSaneamientoFinalizacion
    {
        #region Constructors

        public ExpedienteEstadoSaneamientoFinalizacion()
        {
        }
        public ExpedienteEstadoSaneamientoFinalizacion(int idExpedienteEstado)
        {
