...
{
    [Table("ExpedienteEstadoTestamentarioFinalizacion")]
    public class ExpedienteEstadoTestamentarioFinalizacion
    {
        #region Constructors

        public ExpedienteEstadoTestamentarioFinalizacion()
        {
        }
        public ExpedienteEstadoTestamentarioFinalizacion(int idExpedienteEstado)
        {
