...
{
    [Table("ExpedienteEstadoVerbalFinalizacion")]
    public class ExpedienteEstadoVerbalFinalizacion
    {
        #region Constructors

        public ExpedienteEstadoVerbalFinalizacion()
        {
        }
        public ExpedienteEstadoVerbalFinalizacion(int idExpedienteEstado)
        {
