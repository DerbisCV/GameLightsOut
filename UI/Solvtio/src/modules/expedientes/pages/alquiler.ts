...
@Component({
  selector: 'page-Expediente-alquiler',
  templateUrl: './alquiler.html',
  styleUrls: ['./list.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class ExpedienteAlquilerListComponent implements OnInit {
  ...
  async filtrar() {
    ...
    //this.expedienteSearch.paginationFilter.filter.idTipo4 = 5;
